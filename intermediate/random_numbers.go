...
func main() {
	...
	// val := rand.New(rand.NewSource(42)) //fixed seed / you can use time.Now().Unix() as a source
	// fmt.Println(val.Intn(101))
	// fmt.Println(rand.Intn(16) + 5) //minimum 5 maximum(included 20) [5:5+16)  [5:21) 21 not included
